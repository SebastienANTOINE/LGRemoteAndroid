...
public class Hex {
	...
	/** Default charset name is {@link Charsets#UTF_8}. @since 1.7 */
	public static final Charset DEFAULT_CHARSET = Charset.forName("ASCII");

	/** Default charset name is {@link CharEncoding#UTF_8}. @since 1.4 */
	 ...
	 * @param toLowerCase
	 *            the to lower case
	 * @return A char[] containing hexadecimal characters {@code true} converts
	 *         to lowercase, {@code false} to uppercase
	 * @since 1.4
	 */
